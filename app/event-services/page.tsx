...
export const metadata = {
    ...
    description:
        "Hire the best event management company in India for weddings, corporate events, birthday parties and luxury celebrations. Professional event planners delivering unforgettable experiences.",
    keywords: [
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        description:
                            "Premium event management company in India specializing in weddings, corporate events and private celebrations.",
                        areaServed: "India",
                    }),
                }}
            />
