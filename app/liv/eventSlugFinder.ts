...
export function findEventPath(slugPath: string[]) {


    return findNodePath(services, slugPath)
}

// let currentList = services
// let current = null
...
//     city?: string
// ): string {
//     // ✅ titleSuffix hai toh use karo
//     if ((node as any).titleSuffix) {
//         return `${node.title} ${(node as any).titleSuffix}`
//     }
//     // ✅ Safe keyword extraction
//     const keyword =
//         Array.isArray(slug) && slug.length > 1
