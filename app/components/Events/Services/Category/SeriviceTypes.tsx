...
const fallbackConferences = [
    {
        ...
        description: "Large scale conferences bringing industry leaders, professionals and innovators together.",
    },
    {
        icon: Users,
        title: "Leadership Summits",
        slug: "leadership-summit",
        description: "Executive level gatherings focused on leadership strategy and future business direction.",
    },
    {
        icon: Globe,
        title: "International Conferences",
        slug: "international-conference",
        description: "Global conferences hosting speakers and delegates from multiple countries.",
    },
    {
        icon: Presentation,
        title: "Product Launch Conferences",
        slug: "product-launch-conference",
        description: "Strategically designed conferences to unveil new products with media coverage.",
    },
    {
        icon: Lightbulb,
        title: "Innovation Conferences",
        slug: "innovation-conference",
        description: "Events focused on innovation, technology discussions and startup ecosystem collaboration.",
    },
    {
        icon: Building,
        title: "Corporate Annual Conferences",
        slug: "annual-conference",
        description: "Annual corporate gatherings for company updates, strategy discussions and engagement.",
    },
];
...
export default function ServiceTypes({ title }: ServiceTypesProps) {

    console.log("ServiceTypes title:", title); // debug

    const sectionTitle = title || "Conference Types We Manage";
        ...
        <section className="py-20 bg-neutral-950 text-white">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {fallbackConferences.map((conf, index) => {
