    ...
    return (
        <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                ...
                {queries?.map((q) => (
                    <div key={q.id} className="grid grid-cols-5 gap-4 px-6 py-4 border-b border-gray-50 hover:bg-gray-50 transition-colors">
                        <span className="text-sm font-medium text-gray-800 truncate">{q.id}</span>
                        ...
                        <span className="text-sm text-gray-500">{q.mobile}</span>
