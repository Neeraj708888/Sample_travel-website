...
/**
 * 🔹 Title-based matching (safe for batched AI cards)
 */
function findAiCard(aiCards: Partial<Card>[], title: string): Partial<Card> | undefined {
    return aiCards.find(
...
export function mapCards(
    ...
    return items.map((item) => {
        ...
        const aiCard = findAiCard(aiCards, item.title)
